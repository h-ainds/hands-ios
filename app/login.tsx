    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.nextResendTime) {
          ...
          startCooldownTimer(Math.ceil(remainingMs / 1000))
        }
      }
    } catch (error: any) {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      if (
        ...
        if (cooldownStatus.remainingSeconds > 0) {
          startCooldownTimer(cooldownStatus.remainingSeconds)
        }
      } else {
        Alert.alert('Error', msg || 'Failed to sign in. Please check your credentials.')
      }
    } finally {
      setLoading(false)
    }
        ...
        >
          <View className="flex-1 px-6 pt-6">
            ...
            <View className="mt-8">
              ...
              <Text className="text-secondary-placeholder leading-normal mt-1">
            ...
            <View className="mt-6 items-center">
              <Link href="/forgot-password" asChild>
                <TouchableOpacity>
                  <Text className="text-secondary-muted">
                    Forgot password?
                  </Text>
                </TouchableOpacity>
              </Link>
